...
echo ls $source_path | xargs -n1 -I{} -t sh -c "mkdir -p $target_path/{}.d && ffmpeg -hwaccel cuda -i /nfs/home/rhotertj/datasets/hbl/videos/{} -qscale:v 2 -start_number 0 -vf scale=-1:256 $target_path/{}.d/%06d.jpg"
